...
Creates a new DatoCMS project. To authorize the request you need to provide your email, password, and one-time code (if you abilitated 
the two factor authentication)

```
USAGE
  $ datocms projects:create [NEW_PROJECT_NAME] [--email <value>] [--password <value>] [--otp-code <value>] [--organization-id <value>]
...
DESCRIPTION
  Creates a new blank project or a new project from a template.
```
...
_See code: [lib/commands/environments/destroy.js](https://github.com/datocms/cli/blob/v1.1.9/packages/cli/lib/commands/environments/destroy.js)_
...
_See code: [lib/commands/environments/list.js](https://github.com/datocms/cli/blob/v1.1.9/packages/cli/lib/commands/environments/list.js)_
...
_See code: [lib/commands/environments/primary.js](https://github.com/datocms/cli/blob/v1.1.9/packages/cli/lib/commands/environments/primary.js)_
...
_See code: [lib/commands/environments/promote.js](https://github.com/datocms/cli/blob/v1.1.9/packages/cli/lib/commands/environments/promote.js)_
...
_See code: [lib/commands/maintenance/off.js](https://github.com/datocms/cli/blob/v1.1.9/packages/cli/lib/commands/maintenance/off.js)_
...
_See code: [lib/commands/maintenance/on.js](https://github.com/datocms/cli/blob/v1.1.9/packages/cli/lib/commands/maintenance/on.js)_
...
_See code: [lib/commands/migrations/new.js](https://github.com/datocms/cli/blob/v1.1.9/packages/cli/lib/commands/migrations/new.js)_
...
_See code: [lib/commands/migrations/run.js](https://github.com/datocms/cli/blob/v1.1.9/packages/cli/lib/commands/migrations/run.js)_
...
_See code: [lib/commands/plugins/available.js](https://github.com/datocms/cli/blob/v1.1.9/packages/cli/lib/commands/plugins/available.js)_
...
_See code: [lib/commands/profile/remove.js](https://github.com/datocms/cli/blob/v1.1.9/packages/cli/lib/commands/profile/remove.js)_
...
_See code: [lib/commands/profile/set.js](https://github.com/datocms/cli/blob/v1.1.9/packages/cli/lib/commands/profile/set.js)_
<!-- commandsstop -->
